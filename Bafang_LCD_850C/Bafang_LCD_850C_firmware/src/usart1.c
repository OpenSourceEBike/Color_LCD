...
static uart_rx_data_t *mp_uart_rx_data;
...
#define VARIABLE_ID_MAX_NUMBER 9
      ...
      // start up byte
      ui8_tx[0] = 0x59;
      ui8_tx[1] = ui8_master_comm_package_id;
      ui8_tx[2] = ui8_slave_comm_package_id;

      // set assist level value
      if(p_configuration_variables->ui8_assist_level)
      {
        ui8_tx[3] = p_configuration_variables->ui8_assist_level_factor [((p_configuration_variables->ui8_assist_level) - 1)];
      }
      else
      {
        ui8_tx[3] = 0;
      ...
      // set offroad state
      ui8_tx[4] = (p_motor_controller_data->ui8_lights & 1) |
          ((p_motor_controller_data->ui8_walk_assist_level & 1) << 1) |
          ((p_motor_controller_data->ui8_offroad_mode & 1) << 2);

      // battery max current in amps
      ui8_tx[5] = p_configuration_variables->ui8_battery_max_current;

      // battery power
      ui8_tx[6] = p_configuration_variables->ui8_target_max_battery_power;

      switch(ui8_master_comm_package_id)
      {
        case 0:
          // battery low voltage cut-off
          ui8_tx[7] = (uint8_t) (p_configuration_variables->ui16_battery_low_voltage_cut_off_x10 & 0xff);
          ui8_tx[8] = (uint8_t) (p_configuration_variables->ui16_battery_low_voltage_cut_off_x10 >> 8);
        break;

        case 1:
          // wheel perimeter
          ui8_tx[7] = (uint8_t) (p_configuration_variables->ui16_wheel_perimeter & 0xff);
          ui8_tx[8] = (uint8_t) (p_configuration_variables->ui16_wheel_perimeter >> 8);
        break;

        case 2:
          // wheel max speed
          ui8_tx[7] = p_configuration_variables->ui8_wheel_max_speed;
        break;
        ...
        case 3:
          ...
          ui8_tx[7] = ((p_configuration_variables->ui8_cruise_control & 1) |
          ...
          ui8_tx[8] = p_configuration_variables->ui8_startup_motor_power_boost_state;
        break;

        case 4:
          // startup motor power boost
          ui8_tx[7] = p_configuration_variables->ui8_startup_motor_power_boost_factor [((p_configuration_variables->ui8_assist_level) - 1)];
          // startup motor power boost time
          ui8_tx[8] = p_configuration_variables->ui8_startup_motor_power_boost_time;
        break;

        case 5:
          // startup motor power boost fade time
          ui8_tx[7] = p_configuration_variables->ui8_startup_motor_power_boost_fade_time;
          // boost feature enabled
          ui8_tx[8] = (p_configuration_variables->ui8_startup_motor_power_boost_feature_enabled & 1) ? 1 : 0;
        break;

        case 6:
          // motor over temperature min and max values to limit
          ui8_tx[7] = p_configuration_variables->ui8_motor_temperature_min_value_to_limit;
          ui8_tx[8] = p_configuration_variables->ui8_motor_temperature_max_value_to_limit;
        break;

        case 7:
          // offroad mode configuration
          ui8_tx[7] = ((p_configuration_variables->ui8_offroad_feature_enabled & 1) |
                                ((p_configuration_variables->ui8_offroad_enabled_on_startup & 1) << 1));
          ui8_tx[8] = p_configuration_variables->ui8_offroad_speed_limit;
        break;

        case 8:
          // offroad mode power limit configuration
          ui8_tx[7] = p_configuration_variables->ui8_offroad_power_limit_enabled & 1;
          ui8_tx[8] = p_configuration_variables->ui8_offroad_power_limit_div25;
        break;
    ...
    // signal that we processed a package (even if data was wrong)
