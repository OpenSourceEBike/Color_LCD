case ILI9325D_16ALT:
	...
	UTFT_LCD_Write_COM_DATA(0x10, 0x1590); // SAP, BT[3:0], AP, DSTB, SLP, STB  
	UTFT_LCD_Write_COM_DATA(0x11, 0x0227); // Set DC1[2:0], DC0[2:0], VC[2:0]  
	delay(50); // Delay 50ms  
	UTFT_LCD_Write_COM_DATA(0x12, 0x009C); // 0012  
	delay(50); // Delay 50ms  
	UTFT_LCD_Write_COM_DATA(0x13, 0x1900); // VDV[4:0] for VCOM amplitude  
	UTFT_LCD_Write_COM_DATA(0x29, 0x0023); // 04  VCM[5:0] for VCOMH  
	UTFT_LCD_Write_COM_DATA(0x2B, 0x000E); // Set Frame Rate  
	delay(50); // Delay 50ms  
