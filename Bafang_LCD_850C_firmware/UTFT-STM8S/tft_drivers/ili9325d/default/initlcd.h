...
case ILI9325D_16:
	...
	UTFT_LCD_Write_COM_DATA(0x02, 0x0200); // set 1 line inversion  
	...
	UTFT_LCD_Write_COM_DATA(0x10, 0x1690); // SAP, BT[3:0], AP, DSTB, SLP, STB  
	UTFT_LCD_Write_COM_DATA(0x11, 0x0227); // Set DC1[2:0], DC0[2:0], VC[2:0]  
	delay(50); // Delay 50ms  
	UTFT_LCD_Write_COM_DATA(0x12, 0x000D); // 0012  
	delay(50); // Delay 50ms  
	UTFT_LCD_Write_COM_DATA(0x13, 0x1200); // VDV[4:0] for VCOM amplitude  
	UTFT_LCD_Write_COM_DATA(0x29, 0x000A); // 04  VCM[5:0] for VCOMH  
	...
	UTFT_LCD_Write_COM_DATA(0x31, 0x0404);  
	UTFT_LCD_Write_COM_DATA(0x32, 0x0003);  
	UTFT_LCD_Write_COM_DATA(0x35, 0x0405);  
	UTFT_LCD_Write_COM_DATA(0x36, 0x0808);  
	UTFT_LCD_Write_COM_DATA(0x37, 0x0407);  
	UTFT_LCD_Write_COM_DATA(0x38, 0x0303);  
	UTFT_LCD_Write_COM_DATA(0x39, 0x0707);  
	UTFT_LCD_Write_COM_DATA(0x3C, 0x0504);  
	UTFT_LCD_Write_COM_DATA(0x3D, 0x0808);  
	//------------------ Set GRAM area ---------------//  
	...
	UTFT_LCD_Write_COM_DATA(0x92, 0x0000);  
