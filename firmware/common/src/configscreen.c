...
static Field variousMenus[] =
		{
						...
						FIELD_EDITABLE_ENUM(_S("Motor assist", "Assist"), &l3_vars.ui8_motor_assistance_startup_without_pedal_rotation, "/w pedal", "always"), // FIXME, share one array of disable/enable strings
				FIELD_END };
...
static Field batteryMenus[] = {
  FIELD_EDITABLE_UINT("Max current", &l3_vars.ui8_battery_max_current, "amps", 1, 30),
  FIELD_EDITABLE_UINT("Current ramp", &l3_vars.ui8_ramp_up_amps_per_second_x10, "amps", 4, 255, .div_digits = 1),
  FIELD_EDITABLE_UINT("Low cut-off voltage", &l3_vars.ui16_battery_low_voltage_cut_off_x10, "volts", 160, 630, .div_digits = 1),
  FIELD_EDITABLE_UINT("Number cells", &l3_vars.ui8_battery_cells_number, "", 7, 14),
  FIELD_EDITABLE_UINT("Resistance", &l3_vars.ui16_battery_pack_resistance_x1000, "mohm", 0, 1000),
  FIELD_READONLY_UINT("Voltage (read only)", &l3_vars.ui16_battery_voltage_soc_x10, "volts", .div_digits = 1),
  FIELD_END };
